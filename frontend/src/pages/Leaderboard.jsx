...
const Leaderboard = () => {
  ...
  return (
    <>
      <section className="w-full ml-0 m-0 h-fit px-5 pt-5 lg:pl-[320px] flex flex-col">
        {loading ? (
          <Spinner />
        ) : (
          <>
            <div className="flex flex-col min-[340px]:flex-row min-[340px]:gap-2 mb-5">
              <h1
                className={`text-[#D6482B] text-2xl font-bold  min-[480px]:text-3xl md:text-4xl `}
              >
                Bidders Leaderboard
              </h1>
            </div>
            <div className="overflow-x-auto">
              <table className="min-w-full bg-white border my-3 border-gray-300">
                <thead>
                  <tr>
