...
const About = () => {
  ...
  return (
    <>
      <section className="w-full ml-0 m-0 h-fit px-5 pt-5 lg:pl-[320px] gap-7 flex flex-col min-h-screen py-4 justify-center">
        <div>
          <h1 className={`text-[#d6482b] text-4xl font-bold mb-2 `}>
            About Us
          </h1>
          <p className="text-xl text-stone-600">
            Welcome to AuctionFlare, the ultimate destination for online
        ...
        <div>
          <h3
            className={`text-[#111] text-xl font-semibold mb-2 min-[480px]:text-xl md:text-2xl lg:text-2xl`}
          >
            Our Mission
          </h3>
          <p className="text-xl text-stone-600">
            At AuctionFlare, our mission is to revolutionize the way people buy
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            Founded by N B Solutions, AuctionFlare was born out of a passion for
        ...
        <div>
          <p className="text-[#d6482b] text-xl font-bold mb-3">
            Thank you for choosing AuctionFlare. We look forward to being a part
