...
const HowItWorks = () => {
  ...
  return (
    <>
      <section className="w-full ml-0 m-0 h-fit px-5 pt-5 lg:pl-[320px] flex flex-col min-h-screen py-4 justify-center">
        <h1 className={`text-[#d6482b] text-4xl font-bold`}>
          Discover How AuctionFlare Operates
        </h1>
            ...
            return (
              ...
              >
                <div className="flex align-center gap-2 items-center">
                  ...
                  <h3
                    className={`text-[#D6482B] text-xl font-semibold  min-[480px]:text-xl md:text-2xl lg:text-3xl`}
                  >
                    {element.title}
                  </h3>
                </div>
