...
const Home = () => {
  ...
  return (
    <>
      <section className="w-full ml-0 m-0 h-fit px-5 pt-5 lg:pl-[320px] flex flex-col min-h-screen justify-center">
        <div>
          <p className="text-[#DECCBE] font-bold text-xl mb-2">
            Transparency Leads to Your Victory
          </p>
          <h1
            className={`text-[#111] text-2xl font-bold mb-2 min-[480px]:text-4xl md:text-4xl xl:text-4xl 2xl:text-8xl`}
          >
            Transparent Auctions
          </h1>
          <h1
            className={`text-[#d6482b] text-2xl font-bold min-[480px]:text-4xl md:text-4xl xl:text-6xl 2xl:text-6xl`}
          >
            Be The Winner
          </h1>
